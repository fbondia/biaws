...
is_deployment_key() {
  case "$1" in
    COMPOSE_PROJECT_NAME|MONGO_PORT|ISSUE_API_PORT|ISSUE_UI_PORT|ISSUE_API_URL|MONGO_URI|ISSUE_DIR|REQUEST_DIR|DOCUMENT_DIR|ATTACHMENT_STORAGE_LOCAL_DIR|BIAWS_MONGO_DATA_PATH|BIAWS_ISSUE_FILES_PATH|BIAWS_REQUEST_FILES_PATH|BIAWS_DOCUMENT_FILES_PATH|BIAWS_PROCEDURE_FILES_PATH|BIAWS_SECRET_FILES_PATH|BIAWS_SECRETS_DIR|BIAWS_SECRETS_KEY_PATH|BIAWS_SECRETS_KEY_FILE|BIAWS_MONITOR_SECRET_FILES_PATH|BIAWS_MONITOR_SHELL_FILES_PATH|BIAWS_MONITOR_EXECUTOR_UID|BIAWS_MONITOR_EXECUTOR_GID|BIAWS_PUBLIC_URL|BIAWS_TRUSTED_ORIGINS|BETTER_AUTH_URL|BETTER_AUTH_TRUSTED_ORIGINS|BETTER_AUTH_TRUSTED_PROXIES|BETTER_AUTH_SECURE_COOKIES)
      return 0
      ;;
    *) return 1 ;;
  esac
