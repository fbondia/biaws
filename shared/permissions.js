const definitions = [
  ...
  ["business_rules.read", "Regras de negócio", "Consultar regras de negócio"],
  ["business_rules.create", "Regras de negócio", "Criar regras de negócio"],
  ["business_rules.update", "Regras de negócio", "Alterar regras de negócio"],
  ["business_rules.archive", "Regras de negócio", "Arquivar regras de negócio"],
  [
  ...
  [
    "architecture_decisions.archive",
    "Decisões arquiteturais",
    "Arquivar decisões arquiteturais",
  ],
  [
